...
public class Fraction implements Comparable<Fraction>
{
	...
	// Return negative if this is smaller than other
	public int compareTo(Fraction other) {
		return this.toDouble() - other.toDouble() > 0 ? 1 : -1;
	}
	...
	public boolean equals(Object other) {
		...
		return this.multiply(that.getReciprocal()).toDouble() == 1;
	}

	/**
	 * Constructs a new fraction with a specified
	...
	/**
	 * Returns a String representing this fraction as a mixed number.
	 * 
	 * @
	 */
	public String toMixedNumber() {
		...
		result += Math.abs(numerator) % denominator + "/" + denominator;
