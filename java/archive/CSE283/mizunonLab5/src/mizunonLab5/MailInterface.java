 ...
 * @author bachmann
 * 
 *         The MailClient class provides the user interface and calls the other
 *         classes as needed. When you press Send, the MailClient class
 *         constructs a Message class object to hold the mail message.
 */
public class MailInterface extends JFrame {
    ...
    // Label and text field for entering the server that is being contacted to
    // send the mail
    private JLabel outgoingServerLabel = new JLabel("SMTP Mail Server ");
    private TextField outgoingServerField = new TextField("mailfwd.muohio.edu",
            40);
     ...
     * 
     * @param panel
     *            containing server, from, to, and subject panels.
     */
    ...
    /**
     * Creates a panel contain three buttons. Buttons allow the user to clear
     * the text fields, send a message of quit the program.
     * 
