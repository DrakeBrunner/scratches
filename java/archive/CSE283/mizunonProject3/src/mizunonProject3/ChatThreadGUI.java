...
/**
 * @author bachmann (modified by Naoki Mizuno)
 * 
...
public class ChatThreadGUI extends JDialog {
     ...
     */
    private static final long serialVersionUID = -9082686736250132348L;
    ...
    // Label and TextArea in which received text is displayed
    ...
    private ChatThreadInterfaceListener owner;
    ...
    private static Point locationTracker =
    ...
    private JPanel buildButtonPanel() {
        ...
        btSend.addActionListener(new ButtonListener());
        btClear.addActionListener(new ButtonListener());
        btQuit.addActionListener(new ButtonListener());
    ...
    class ButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            else if (clickedButton == btClear) {
                clearFields();
            }
            else if (clickedButton == btQuit) {
                endChatSession();
            }
        }
    }
     ...
     * 
     * @param owner
     *            reference for the object that will handle events
     */
