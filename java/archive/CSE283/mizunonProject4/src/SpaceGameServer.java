 ...
 *         that are received from clients are used to update the state of the
 *         game
...
public class SpaceGameServer {
    ...
    /**
     * Synchronized method to create thread safe access to the
     * playerTCPConnections data member.
     * 
     * @param persistConnect
     *            Object to be added to the ArrayList
     */
    protected synchronized void addPersistentConnection(
            PersistentConnectionToClient persistConnect) {
     ...
     * 
     * @param persistConnect
     *            Object to be removed from the ArrayList
     */
    protected synchronized void removePersistentConnection(
            PersistentConnectionToClient persistConnect) {
    ...
    /**
     * Synchronized method to create thread safe access to the
     * clientDatagramSocketAddresses data member.
     * 
     * @param ISA
     *            IP address and port number of the DatagramSocket being added
     *            to the ArrayList
     */
    protected synchronized void addClientDatagramSocketAddresses(
     ...
     * 
     * @param ISA
     *            IP address and port number of the DatagramSocket to be removed
     *            from the ArrayList
     */
    protected synchronized void removeClientDatagramSocketAddresses(
            InetSocketAddress ISA) {
    ...
    /**
     * Implements the "accept" loop of a TCP server. Instantiates a new
     * PersistentConnectionToClient object for each connection, starts it, and
     * saves a reference to it in the playerTCPConnections ArrayList.
     */
        ...
        try {
            ...
            while (playing) {
                ...
                try {
                    ...
                    PersistentConnectionToClient pesistConnect = new PersistentConnectionToClient(
                            gameServerSocket.accept(), this);
                    pesistConnect.start();
                    ...
                    System.err
                            .println("Error creating persistent connection to client.");
                }
            }
    ...
    protected void createObstacles() {
        for (int i = 0; i < Constants.NUMBER_OF_OBSTACLES; i++) {
            ...
            sector.addObstacle(new Obstacle(rand
                    .nextInt(Constants.MAX_SECTOR_X),
    ...
    /**
     * Sends remove information for a particular SpaceCraft or Torpedo to all
     * clients.
     * 
     * @param sc
     *            ship to be removed
     ...
     *            socket to use to send the message
     */
    synchronized protected void selectiveForward(DatagramPacket fwdPack,
     ...
     *            socket to use to send the message
     */
    synchronized protected void allForward(DatagramPacket fwdPack,
