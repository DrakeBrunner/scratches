 ...
 * Comment: There are multiple way that this can be done.  But in order to
 ...
 *          lengh of msg, and *newSize should be set to the size of the
 *          returned array.
...
/* Purpose: Decrypt the encoding using key pair (d, n).  size is the size
 *          of the encoding array, while newSize is set to the size of the array
 *          created by the algorithm.  Assume each integer in the encoding 
...
/* 
 * Don't forget to write the main function in main.cpp as part of Phase 02!!!
 */
